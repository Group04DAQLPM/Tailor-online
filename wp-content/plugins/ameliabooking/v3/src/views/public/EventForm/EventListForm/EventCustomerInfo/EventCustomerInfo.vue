...
let instantBooking = ref(usePrepaidPrice(
  store,
  store.getters['eventEntities/getEvent'](store.getters['eventBooking/getSelectedEventId']),
  store.getters['bookableType/getType']
) === 0)
