    ...
    <div id="am-email-notifications" class="am-body">
      ...
      <div class="am-notifications am-section">
        <el-tabs v-model="notificationTab" @tab-click="inlineSVG()" v-if="fetched">
          ...
          <!-- Email Notifications -->
          <el-tab-pane
              :label="$root.labels.email_notifications"
              name="email">
          ...
          <!-- SMS Notifications -->
          <el-tab-pane
              :label="$root.labels.sms_notifications"
              name="sms">
            <sms-notifications
          ...
          <el-tab-pane
              :label="$root.labels.whatsapp_notifications"
              name="whatsapp"
              v-if="$root.licence.isPro || $root.licence.isDeveloper">
            <BlockLite/>
