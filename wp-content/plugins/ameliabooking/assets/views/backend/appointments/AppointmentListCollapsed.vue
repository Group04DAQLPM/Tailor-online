                ...
                <el-col :lg="12" :md="12" :sm="12">
                  ...
                  <el-col :lg="14" :md="14" :sm="14">
                    <div>
                      <p class="am-value">
                        {{
                          app.bookings[key].packageCustomerService && app.bookings[key].packageCustomerService.packageCustomer
                          ? getFormattedPrice(getPackagePrice(app, key)) : getAppointmentPrice(app.serviceId, getAppointmentService(app), [app.bookings[key]], true)
                        }}
                      </p>
                    </div>
                  </el-col>
