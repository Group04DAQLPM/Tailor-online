...
<script>
  ...
  export default {
    ...
    mixins: [liteMixin, customerMixin, paymentMixin, entitiesMixin, imageMixin, dateMixin, checkMixin, notifyMixin, priceMixin, helperMixin, appointmentPriceMixin],
    ...
    created () {
      ...
      if (!this.$root.licence.isBasic && !this.$root.licence.isLite) {
        this.statuses.push(
          {
            value: 'refunded',
