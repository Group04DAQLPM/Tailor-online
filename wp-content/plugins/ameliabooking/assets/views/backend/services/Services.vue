<template>
  <div class="am-wrap">
    <div id="am-services" class="am-body">
      ...
      <!-- Resources -->
      <div v-if="$root.licence.isPro || $root.licence.isDeveloper" v-show="typeTab === 'resources'" class="am-services-categories am-resources-feature" :key="2">
        <BlockLite message="This feature is available only in Pro and Developer licenses."/>

          <el-row class="am-flexed">
            <el-col :md="24">
              <div class="am-resource-section am-services-column">
                <el-row :gutter="16">
                  <el-col :md="24">
                ...
                <!-- Spinner -->
                <div class="am-spinner am-section" v-show="!fetchedResources">
                  <img :src="$root.getUrl+'public/img/spinner.svg'"/>
                </div>

                <!-- Empty State For Resources -->
                <div class="am-empty-state am-section" style="position: relative"
                     v-show="fetchedResources && resources.length === 0 && !searchResource">
                  <img :src="$root.getUrl+'public/img/emptystate.svg'">
                  <h2>{{ $root.labels.no_resources_yet }}</h2>
                  <p>{{ $root.labels.click_add_resource }}</p>
                </div>
...
export default {
    ...
    methods: {
      ...
      showDialogNewResource: !AMELIA_LITE_VERSION ? function () {
