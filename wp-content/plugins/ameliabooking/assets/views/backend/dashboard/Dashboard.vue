<template>
  <div class="am-wrap">
    ...
    <transition name="fade" id="am-lite-promo"> <!---->
      <div
        class="am-qanda-banner"
        v-if="$root.settings.activation.enableAmeliaQAPromoBanner && ameliaQAPromoBannerVisible && (getDateTime('2023-05-12 00:00:00') > getNowDate())"
      >
        <img class="large" :src="$root.getUrl + 'public/img/promo/amelia-qanda-banner.webp'"/>
        <img class="small" :src="$root.getUrl + 'public/img/promo/amelia-qanda-banner-small.png'"/>
        <p @click="removeBanner"><img :src="$root.getUrl + 'public/img/promo/am-close-x.svg'" alt="Close"></p>
        <a class="am-YT-button" href="https://www.youtube.com/c/AmeliaWordPressBookingPlugin" target="_blank"></a>
      ...
      <div v-if="$root.settings.activation.enableAmeliaPromoBanner && promoBannerEnabled" class="am-promo-banner"
        ...
        <div class="am-promo-banner__content">
          ...
          <div class="am-promo-banner__buttons">
            ...
            <a @click="grabYoursBtnHandler" href="" class="am-promo-banner__button am-pricing-page-btn">{{ $root.labels.grab_yours }}</a>
          </div>
        </div>
      </div>
    </transition>
    ...
    <div id="am-dashboard" class="am-body">
      ...
      <transition name="fade" id="am-wpdt-promo">
...
<script>
  ...
  export default {
    ...
    data () {
      return {
        ameliaQAPromoBannerVisible: true,
    ...
    methods: {
      grabYoursBtnHandler (e) {
        e.preventDefault()
        window.open('https://wpamelia.com/pricing?utm_source=amelia-lite&utm_medium=lite-upgrade&utm_content=amelia&utm_campaign=amelia-lite', '_blank')
      },
