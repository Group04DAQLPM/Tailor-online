<template>
  <div id="amelia-booking-wrap" class="am-wrap">
                        ...
                        <el-row class="justify-content-center">
                          <el-col :sm="12" :lg="12"  class="am-ticket-info">
                            ...
                            <span v-if="!evt.maxCustomCapacity && eventSpotsVisibility">
                              {{ ticketSpotsNumber(evt, index, ticket) }}
                            </span>
                          </el-col>
    ...
    <div class="am-lite-footer">
      <a
        v-if="$root.isLite && $root.settings.general.backLink.enabled"
        rel="nofollow"
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      ticketSpotsNumber (evt, index, ticket) {
        let spots = ticket.spots - ticket.sold - evt.bookingToEventTickets[index].persons
