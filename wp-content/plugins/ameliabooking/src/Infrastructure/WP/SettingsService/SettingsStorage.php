...
class SettingsStorage implements SettingsStorageInterface
{
    ...
    {
        $this->locationService = new CurrentLocationLite();
    ...
    public function getFrontendSettings()
    {
        ...
        return [
            ...
            'outlookCalendar'        =>
                !AMELIA_LITE_VERSION && $this->getSetting('outlookCalendar', 'clientID') && $this->getSetting('outlookCalendar', 'clientSecret'),
            'zoom'                   => [
                'enabled' => !AMELIA_LITE_VERSION && (
            ...
            'activation'             => [
                'enableAmeliaQAPromoBanner'     => $this->getSetting('activation', 'enableAmeliaQAPromoBanner'),
                'enableAmeliaPromoBanner'       => $this->getSetting('activation', 'enableAmeliaPromoBanner'),
