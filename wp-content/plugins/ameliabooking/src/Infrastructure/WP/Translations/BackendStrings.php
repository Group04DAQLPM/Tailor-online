...
%company_name%'),
    ...
    public static function getDashboardStrings()
    {
        return [
            ...
            'coupon_text'                   => __('Apply "AMELIA30" coupon code and get 30% on all prices!', 'wpamelia'),
            'promo_text'                    => __('Upgrade your Amelia Lite to Premium ', 'wpamelia'),
