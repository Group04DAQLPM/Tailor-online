=== WP Adminify - Custom Login, Admin Dashboard, Admin Columns | White Label | Media Library Folders ===
Contributors: jwthemeltd, litonice13, masteraddons
Tags: Custom Dashboard, White Label, Custom Admin Panel, Media Library Folders, Dashboard widgets, Admin login
...
WP Adminify comes with some pre-built Template for your Dashboard. With a single click, you can change the entire color scheme of your WordPress Admin area. It has a perfect setup wizard, where you can enable or disable all necessary modules, define your website's logo, and more.
