...
class AdminifyPromo
{
    ...
    public function jltwp_adminify_latest_update_details()
    {
        ...
        $jltwp_adminify_changelog_message = sprintf(
            ...
            // %3$s
            __( '<span class="dashicons dashicons-yes"></span> <span class="adminify-changes-list"> Menu Editor - Export/Import menu editor settings updated </span><br>', 'adminify' ),
            __( '<span class="dashicons dashicons-yes"></span> <span class="adminify-changes-list"> For Network Admin - unnecessary Admin menu showing issue fixed </span><br>', 'adminify' ),
            __( '<span class="dashicons dashicons-yes"></span> <span class="adminify-changes-list"> WP Adminify Options Export and Import issue fixed </span><br>', 'adminify' ),
            __( '<span class="dashicons dashicons-yes"></span> <span class="adminify-changes-list"> CSS issue with "Sassy Social Share" & "Dokan" plugin issue fixed </span><br>', 'adminify' ),
            __( '<span class="dashicons dashicons-yes"></span> <span class="adminify-changes-list"> Option Settings > Yoast SEO< Duplicate Post, Contact Form 7 Dark Mode color issue fixed </span><br>', 'adminify' )
        );
