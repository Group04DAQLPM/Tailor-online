...
class Expert_Tailor_Loader {
	 ...
	 * @return void
	 */
	public function expert_tailor_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function expert_tailor_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function expert_tailor_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function expert_tailor_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->expert_tailor_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function expert_tailor_load( $class ) {
